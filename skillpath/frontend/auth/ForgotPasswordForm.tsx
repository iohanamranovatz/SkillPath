...
import { requestPasswordReset } from '@/backend/auth/resetPasswd';
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-[#101218] p-4 text-gray-100 font-sans">
                <div className="w-full max-w-md bg-[#1C1F28] border border-gray-800 rounded-2xl p-8 shadow-2xl text-center space-y-6">
                    ...
                    <p className="text-sm text-gray-400">If an account exists with this email address, we have sent instructions to reset your password.</p>
                    <Link
                        href="/login"
            ...
            <div className="w-full max-w-md bg-[#1C1F28] border border-gray-800 rounded-2xl p-8 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-[#6B72E1] hover:bg-[#585ed6] text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 shadow-lg shadow-[#6B72E1]/20 mt-4 flex items-center justify-center gap-2 disabled:opacity-50"
                    >
